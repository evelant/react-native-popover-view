...
var AdaptivePopover = /** @class */ (function (_super) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, new Promise(function (resolve) {
                                _this.setState({
                                    ...
                                    displayAreaOffset: displayAreaOffset_1
    ...
    AdaptivePopover.prototype.calculateRectFromRef = function () {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            var fromRef, initialRect, displayAreaOffset, count, _d, width, height, defaultRect, shouldAdjustForAndroidStatusBar, verticalOffsetAndroidAdjustment, verticalOffset, horizontalOffset, rect, _e, width, height, error_1, error_2, _f, width, height, defaultRect;
            return __generator(this, function (_g) {
                switch (_g.label) {
                    case 0:
                        fromRef = this.props.fromRef;
                        initialRect = this.state.fromRect || new Rect(0, 0, 0, 0);
                        displayAreaOffset = (_a = this.state.displayAreaOffset) !== null && _a !== void 0 ? _a : {
                            x: 0,
                            y: 0
                        };
                        ...
                        _g.label = 1;
                    case 1:
                        if (!!fromRef.current) return [3 /*break*/, 3];
                        return [4 /*yield*/, new Promise(function (resolve) {
                    ...
                    case 2:
                        ...
                        if (count++ > 20) {
                            ...
                            if (this._isMounted) {
                                _d = Dimensions.get('window'), width = _d.width, height = _d.height;
                                defaultRect = new Rect(width / 2, height / 2, 0, 0);
                    ...
                    case 4:
                        ...
                        _g.label = 5;
                    case 5:
                        _g.trys.push([5, 10, , 12]);
                        return [4 /*yield*/, getRectForRef(fromRef)];
                    case 6:
                        rect = _g.sent();
                        if (!(rect.width === 0 && rect.height === 0 && rect.x === 0 && rect.y === 0)) return [3 /*break*/, 8];
                    ...
                    case 7:
                        ...
                        if (count++ > 20) {
                            ...
                            if (this._isMounted) {
                                _e = Dimensions.get('window'), width = _e.width, height = _e.height;
                    ...
                    case 10:
                        error_1 = _g.sent();
                        this.debug("calculateRectFromRef - error getting rect: " + error_1);
                    ...
                    case 11:
                        ...
                        return [3 /*break*/, 12];
                    case 12:
                        if (!rect || !AdaptivePopover.hasRetrievedSatisfyingRect(rect, initialRect)) return [3 /*break*/, 5];
                        _g.label = 13;
                    case 13:
                    ...
                    case 14:
                        error_2 = _g.sent();
                        this.debug("calculateRectFromRef - unexpected error: " + error_2);
                        // If we encounter an unexpected error, use a default rect in the center of the screen
                        if (this._isMounted) {
                            _f = Dimensions.get('window'), width = _f.width, height = _f.height;
                            defaultRect = new Rect(width / 2, height / 2, 0, 0);
                            this.setState({ fromRect: defaultRect });
                        }
                        return [3 /*break*/, 15];
